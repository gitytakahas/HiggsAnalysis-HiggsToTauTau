...
//#include "/afs/cern.ch/user/y/ytakahas/work/H2TauTau_bbb_pT30/CMSSW_6_1_1/src/HiggsAnalysis/HiggsToTauTau/interface/HttStyles.h"
//#include "/afs/cern.ch/user/y/ytakahas/work/H2TauTau_bbb_pT30/CMSSW_6_1_1/src/HiggsAnalysis/HiggsToTauTau/test/templates/sobWeightedCombine.C"
//#include "/afs/cern.ch/user/y/ytakahas/work/H2TauTau_bbb_pT30/CMSSW_6_1_1/src/HiggsAnalysis/HiggsToTauTau/test/templates/sobWeightedCombineMSSM.C"

#include "HttStyles.h"
#include "sobWeightedCombine.C"
#include "sobWeightedCombineMSSM.C"
...
//  All_SM[ 1]="ee_vbf_postfit_8TeV_LIN";
  ...
  All_SM[ 6]="mumu_vbf_postfit_7TeV_LOG";
  All_SM[ 7]="mumu_vbf_postfit_8TeV_LOG";
...
//  All_SM[41]="ee_0jet_high_postfit_8TeV_LIN";
  ...
  All_SM[32]="eleTau_0jet_medium_postfit_7TeV_LIN";
  All_SM[33]="eleTau_0jet_medium_postfit_8TeV_LIN"; 
  All_SM[34]="eleTau_0jet_high_postfit_7TeV_LIN";
  All_SM[35]="eleTau_0jet_high_postfit_8TeV_LIN"; 
...
//  All_SM[39]="muTau_0jet_low_postfit_8TeV_LIN";
  All_SM[36]="muTau_0jet_medium_postfit_7TeV_LIN";
  All_SM[37]="muTau_0jet_medium_postfit_8TeV_LIN"; 
  All_SM[38]="muTau_0jet_high_postfit_7TeV_LIN";
  All_SM[39]="muTau_0jet_high_postfit_8TeV_LIN";  
//  //mt soft
...
//  All_SM[49]="muTau_soft_vbf_postfit_8TeV_LIN";
  ...
  EE_SM[ 0]="ee_vbf_postfit_7TeV_LOG";
  EE_SM[ 1]="ee_vbf_postfit_8TeV_LOG";
  EE_SM[ 2]="ee_1jet_low_postfit_7TeV_LOG";
  EE_SM[ 3]="ee_1jet_low_postfit_8TeV_LOG";
  EE_SM[ 4]="ee_1jet_high_postfit_7TeV_LOG";
  EE_SM[ 5]="ee_1jet_high_postfit_8TeV_LOG";
  EE_SM[ 6]="ee_0jet_low_postfit_7TeV_LOG";
  EE_SM[ 7]="ee_0jet_low_postfit_8TeV_LOG";
  EE_SM[ 8]="ee_0jet_high_postfit_7TeV_LOG";
  EE_SM[ 9]="ee_0jet_high_postfit_8TeV_LOG";
  ...
  ETau_SM[ 7]="eleTau_0jet_medium_postfit_7TeV_LIN";
  ETau_SM[ 8]="eleTau_0jet_medium_postfit_8TeV_LIN"; 
  ETau_SM[ 9]="eleTau_0jet_high_postfit_7TeV_LIN";
  ETau_SM[10]="eleTau_0jet_high_postfit_8TeV_LIN"; 

  TString MuMu_SM[NMAXINPUT];
  MuMu_SM[ 0]="mumu_vbf_postfit_7TeV_LOG";
  MuMu_SM[ 1]="mumu_vbf_postfit_8TeV_LOG";
  MuMu_SM[ 2]="mumu_1jet_low_postfit_7TeV_LOG";
  MuMu_SM[ 3]="mumu_1jet_low_postfit_8TeV_LOG";
  MuMu_SM[ 4]="mumu_1jet_high_postfit_7TeV_LOG";
  MuMu_SM[ 5]="mumu_1jet_high_postfit_8TeV_LOG";
  MuMu_SM[ 6]="mumu_0jet_low_postfit_7TeV_LOG";
  MuMu_SM[ 7]="mumu_0jet_low_postfit_8TeV_LOG";
  MuMu_SM[ 8]="mumu_0jet_high_postfit_7TeV_LOG";
  MuMu_SM[ 9]="mumu_0jet_high_postfit_8TeV_LOG"; 
  ...
  MuTau_SM[ 9]="muTau_0jet_medium_postfit_7TeV_LIN";
  MuTau_SM[10]="muTau_0jet_medium_postfit_8TeV_LIN"; 
  MuTau_SM[11]="muTau_0jet_high_postfit_7TeV_LIN";
  MuTau_SM[12]="muTau_0jet_high_postfit_8TeV_LIN";
  
  TString MuTauSoft_SM[NMAXINPUT];
  MuTauSoft_SM[ 0]="muTau_vbf_loose_postfit_7TeV_LIN";
  MuTauSoft_SM[ 1]="muTau_vbf_loose_postfit_8TeV_LIN";
  MuTauSoft_SM[ 2]="muTau_vbf_tight_postfit_8TeV_LIN"; 
  MuTauSoft_SM[ 3]="muTau_1jet_medium_postfit_7TeV_LIN";
  MuTauSoft_SM[ 4]="muTau_1jet_medium_postfit_8TeV_LIN";
  MuTauSoft_SM[ 5]="muTau_1jet_high_lowhiggs_postfit_7TeV_LIN";
  MuTauSoft_SM[ 6]="muTau_1jet_high_lowhiggs_postfit_8TeV_LIN"; 
  MuTauSoft_SM[ 7]="muTau_1jet_high_mediumhiggs_postfit_7TeV_LIN";
  MuTauSoft_SM[ 8]="muTau_1jet_high_mediumhiggs_postfit_8TeV_LIN"; 
  MuTauSoft_SM[ 9]="muTau_0jet_low_postfit_7TeV_LIN";
  MuTauSoft_SM[10]="muTau_0jet_low_postfit_8TeV_LIN";
  MuTauSoft_SM[11]="muTau_0jet_medium_postfit_7TeV_LIN";
  MuTauSoft_SM[12]="muTau_0jet_medium_postfit_8TeV_LIN"; 
  MuTauSoft_SM[13]="muTau_0jet_high_postfit_7TeV_LIN";
  MuTauSoft_SM[14]="muTau_0jet_high_postfit_8TeV_LIN";
  MuTauSoft_SM[15]="muTau_soft_0jet_low_postfit_8TeV_LIN";
  MuTauSoft_SM[16]="muTau_soft_0jet_medium_postfit_8TeV_LIN";
  MuTauSoft_SM[17]="muTau_soft_0jet_high_postfit_8TeV_LIN";
  MuTauSoft_SM[18]="muTau_soft_1jet_medium_postfit_8TeV_LIN";
  MuTauSoft_SM[19]="muTau_soft_1jet_high_postfit_8TeV_LIN";
  MuTauSoft_SM[20]="muTau_soft_vbf_postfit_8TeV_LIN";
  ...
  MuMu_MSSM[0]="mumu_nobtag_postfit_7TeV_LOG";
  MuMu_MSSM[1]="mumu_nobtag_postfit_8TeV_LOG";
  MuMu_MSSM[2]="mumu_btag_postfit_7TeV_LOG";
  MuMu_MSSM[3]="mumu_btag_postfit_8TeV_LOG";
